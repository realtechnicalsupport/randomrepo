    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100dvh", background: T.bg, color: T.ink, fontFamily: T.font, overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ background: T.surface, borderBottom: `1px solid ${T.border}`, padding: "10px 12px", display: "flex", alignItems: "center", gap: 8, flexShrink: 0, zIndex: 10 }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <button onClick={() => setShowSyncPanel(true)} style={{ background: syncToken ? T.sageSoft : T.bgDeep, border: "none", borderRadius: 8, padding: "6px 10px", fontFamily: T.font, fontSize: 12, fontWeight: 700, color: syncToken ? T.sage : T.inkLight, cursor: "pointer", flexShrink: 0 }} title="Sync progress">
            {syncStatus === "syncing" ? "⟳" : syncStatus === "saved" ? "✓" : syncStatus === "error" ? "✗" : "☁"}
          </button>
        </div>
      </div>
